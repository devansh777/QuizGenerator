        ...
        <div class="container-fluid">
           <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo base_url();?>index.php/Mcq_controller/addnewtest" method="POST">
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="txtgrpname">
                        </div>
                      </div>
                 ...
                 <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Select Option:</label><br>
                          <input type="radio" value="randome"  name="option">Random<br>
                          <input type="radio" value="manual"  name="option">Manual<br>
                          <input type="radio" value="marge"  name="option">Merge
                        </div>
                      </div>
                    </div>
                  </div>
