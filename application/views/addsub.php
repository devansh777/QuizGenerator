        ...
        <div class="container-fluid">
           <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo base_url();?>index.php/Mcq_controller/addnewsub" method="POST">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Subject Name:</label>
                          <input type="text" class="form-control" name="txtsubname">
                        </div>
                      </div>
                    </div>
                </div>
                    <button type="submit" name="btnSubmit" class="btn btn-primary pull-right">Add Subject</button>
