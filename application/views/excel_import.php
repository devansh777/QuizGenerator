            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Select Excel File</h4>
                  <p class="card-category"> </p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <form method="post" id="import_form" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/Mcq_controller/import">
                     ...
                     <label class="bmd-label-floating"> Select Excel file :</label>
                    <input type="file" name="file" id="file" class="form-control" required accept=".xls, .xlsx" />
                    <div class="col-md-12">
              <div class="card">
                    <button type="submit" name="btnSubmit" class="btn btn-primary pull-right">Import</button>
                    </form>
		
                  </div></div>
			<a href="<?php echo base_url();?>/assets/excelTemplate.xlsx">Download question's format file</a>
		</div>
                </div>
              </div>
            </div>
