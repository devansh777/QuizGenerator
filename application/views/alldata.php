              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <form action="<?php echo base_url(); ?>index.php/Mcq_controller/deletemultiple" method="POST">
                    <?php $no=1;
                      $ans;
                      if(!empty($result)){?>
                    <table class="table">
                    <thead class=" text-primary">
                      ...
                      { 
                        ...
                        <tbody>
                          <tr>
                            <td><input type='checkbox' value='$row->mcqId' name='$row->mcqId'></td>
                            <td>
                              $row->mcqId
                            </td>
                            <td>
                          ...
                          <td>
                             <a href="<?php echo base_url(); ?>index.php/Mcq_controller/deletemcq/<?php echo $row->mcqId;?>" onClick="return doconfirm();"><font color="Red"><b> Remove </b></font></a>
                          </td>
                          <td>
                   ...
                   <div class="col-md-12">
                    <div class="card">
                     <button type="submit" name="btnSubmit" onClick="return doconfirm();" class="btn btn-primary pull-right">Delete</button> </div></div>
                  </form>
                  </div>
                </div>
              </div>
